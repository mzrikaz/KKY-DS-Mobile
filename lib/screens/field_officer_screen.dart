...
import 'package:kky_ds/models/RegistrarDivision.dart';
import 'package:provider/provider.dart';
import 'package:url_launcher/url_launcher.dart';

class FieldOfficerScreen extends StatefulWidget {
  @override
  _FieldOfficerScreenState createState() => _FieldOfficerScreenState();
}

class _FieldOfficerScreenState extends State<FieldOfficerScreen> {
  var _isInit = true;
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Provider.of<FieldOfficerProvider>(context).fetchAndUpdateList().then((_) {
        setState(() {
          _isLoading = false;
        });
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: FittedBox(
          child: const Text('வௌிக்கள உத்தியோகத்தா்கள்'),
        ),
      ),
      body: _isLoading
