...
class DevelopmentOfficerProvider with ChangeNotifier {
  List<DevelopmentOfficer> _list = [];

  List<DevelopmentOfficer> get gnDivisions {
    return [..._list];
  }
  ...
  Future<void> fetchAndUpdateList() async {
    try {
      final values = await GoogleSheets(
              ...
              sheetName: 'DO')
          .sheetData();
      final List<DevelopmentOfficer> loadedProducts = [];
